...
@section('title', 'About Us - LUXEFITS')

@section('content')

    <!-- ***** Main Banner Area Start ***** -->
    <div class="page-heading about-page-heading" id="top">
        <!-- ... (Paste the "page-heading" div from your about.html here) ... -->
         <div class="container">
        <div class="row">
          <div class="col-lg-12">
    ...
    <!-- ***** About Area Starts ***** -->
    <div class="about-us">
        <!-- ... (Paste the "about-us" div from your about.html here) ... -->
        <div class="container">
        <div class="row">
          <div class="col-lg-6">
    ...
    <section class="our-services">
        <!-- ... (Paste the "our-services" section from your about.html here) ... -->
         <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <div class="section-heading">
