...
@section('title', 'LUXEFITS - Home')

@section('content')

    <!-- ***** Main Banner Area Start ***** -->
    <div class="main-banner" id="top">
        <!-- ... (Paste the entire "main-banner" div from your index.html here) ... -->
                ...
                <div class="col-lg-6">
                  <div class="right-first-image">
                    <div class="thumb">
                      ...
                      <img
                        src="assets\images\athlete-s-set-with-female-clothing-and-bottle-of-water-on-dark-background-photo (1).jpg"
                        style="width: 446px; height: 384px"
                        alt=""
                      />
                    </div>
                  </div>
    ...
    <section class="section" id="men">
        <!-- ... (Paste the entire "men" section from your index.html here) ... -->
        <div class="container">
        <div class="row">
          <div class="col-lg-6">
    ...
    <section class="section" id="women">
        <!-- ... (Paste the entire "women" section from your index.html here) ... -->
        <div class="container">
        <div class="row">
          <div class="col-lg-6">
            <div class="section-heading">
    ...
    <section class="section" id="kids">
        <!-- ... (Paste the entire "kids" section from your index.html here) ... -->
        <div class="container">
        <div class="row">
          <div class="col-lg-6">
            <div class="section-heading">
    ...
    <section class="section" id="explore">
        <!-- ... (Paste the entire "explore" section from your index.html here) ... -->
        <div class="container">
        <div class="row">
          <div class="col-lg-6">
            <div class="left-content">
    ...
    <section class="section" id="social">
        <!-- ... (Paste the entire "social" section from your index.html here) ... -->
        <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <div class="section-heading">
        ...
        <div class="row images">
          ...
          <div class="col-2">
            <div class="thumb">
              ...
              <img src="assets\images\men-01.jpg" height="185.5px" />
            </div>
          </div>
          <div class="col-2">
            <div class="thumb">
